...
<<<<<<< HEAD
Motivation for this project was rooted in the group's collective interest in the impact of public health initiatives on health outcomes. While exploring for related datasets, we found city-level data on health practices and health outcomes from the Centers of Disease Control. Project objectives and analysis plans were mainly driven by the data and the information available from the data set. 
=======
...
>>>>>>> 2559005ee57e5066bb339421737a492e973053db
